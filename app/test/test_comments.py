...
# Test Create reply to an existing Comment
...
@pytest.mark.parametrize("comment_id, update_data, expected_status, expected_detail", [
    (1, {"comment_text": "Updated comment!"}, 200, None),  
    (99009, {"comment_text": "Updated comment!"}, 404, "Comment not found or not authorized"),  
    (1, {"comment_text": "Unauthorized update!"}, 404, "Comment not found or not authorized"), 
])
def test_update_comment(client, setup_db, comment_id, update_data, expected_status, expected_detail):
    ...
    comment_id = created_comment_id if comment_id == 1 else 99009
...
# Test delete comment Unauthorized
@pytest.mark.parametrize("comment_id, expected_status, expected_detail", [
